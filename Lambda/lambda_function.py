...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        ...
        if 0 >= age :
            return build_validation_result(
                False,
                "birthday",
                "You should be between 0 years old or 65 to use this service, "
    ...
    return build_validation_result(True, False,False)
...
def recommend_portfolio(intent_request):
    ...
    recommendation = get_slots(intent_request)["riskLevel"]
    ...
    risk_appetite =risk_level(recommendation)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            good luck with your investment choice{}.
            """.format(
                first_name, risk_appetite
            ),
        },
    )
